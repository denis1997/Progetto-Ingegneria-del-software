...
Public Class Form18
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Try
            connection.Open()
            query1 = "select count(ID) from edificio where IDzona=@id"
            ...
            Dim query As String
            query = "insert into edificio (idposizione,nome,idzona) values ('" & i + 1 & "','" & TextBox2.Text & "','" & TextBox3.Text & "')"
            command = New MySqlCommand(query, connection)
            READER = command.ExecuteReader

            MessageBox.Show("Nuovo edficio aggiunto")
