...
Public Class Form20
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Try
            connection.Open()
            query1 = "select count(ID) from areaaperto where IDzona=@id"
            ...
            Dim query As String
            query = "insert into areaaperto (idposizione,nome,idsottocategorie,idzona) values ('" & i + 1 & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "' )"
