...
insert into `sensore` value (default, 't1', 24°, 1,current_timestamp(), current_timestamp(),default,1);
insert into `sensore` value (default, 't2', 10°, 1,current_timestamp(), current_timestamp(),default,1);
insert into `sensore` value (default, 't3', 6°, 1,current_timestamp(), current_timestamp(),default,1);
insert into `sensore` value (default, 't4', 0, 1,current_timestamp(), current_timestamp(),default,1);
insert into `sensore` value (default, 'u1', 0, 1,current_timestamp(), current_timestamp(),default,1);
insert into `sensore` value (default, 'u2', 0, 0,current_timestamp(), current_timestamp(),default,1);
insert into `sensore` value (default, 'u3', 0, 1,current_timestamp(), current_timestamp(),default,1);
insert into `sensore` value (default, 'l1', 0, 1,current_timestamp(), current_timestamp(),default,1);
insert into `sensore` value (default, 'l2', 0, 1,current_timestamp(), current_timestamp(),default,1);
insert into `areaaperto` value(default, 'aperto1', 1);
insert into `areaaperto` value(default, 'aperto2', 2);
insert into `areaaperto` value(default, 'aperto3',1);
insert into `areaPiano`value (default, 'aula 1', 1);
